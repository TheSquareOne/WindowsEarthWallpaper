...
const web = koffi.load('../Backend/web.dll')
const getWebsiteHeader = web.func('getWebsiteHeader', 'int', ['str'])

function checkForImageUpdate() {

    // const moment = require( 'moment' )
    const US_url = 'https://cdn.star.nesdis.noaa.gov/GOES16/ABI/FD/GEOCOLOR/10848x10848.jpg'
    const test_URL = 'https://example.com'
    let durr = 10000
    let result

    result = getWebsiteHeader(test_URL)
    console.log(result)
